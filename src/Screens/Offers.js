...
const Offers = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View className="relative top-10  px-16  justify-center ">
      ...
      {/* <View className="px-8">
        ...
        <Text className="text-[20px] mb-6 text-[#121212] leading-8">
          ...
          <LinearGradient
            ...
            <View className="flex flex-row w-full justify-around items-center ">
              <View className="flex flex-col px-5 py-4 gap-2 rounded-lg  items-start justify-center bg-[#fefce8]">
                {/* <Text className="text-[#121212] font-medium">Grab it now !</Text> */}
                <Text className="text-[#121212] font-medium">
                  Follow + Review = 5% Off !
                </Text>
              </View>
              <View className="flex flex-col px-1 py-2 rounded-md gap-2 bg-[#fefce8]">
                <TouchableOpacity onPress={handleGoogleRedirect}>
                  ...
                  <Text className="text-[10px] text-[#121212]">
                    Review us !
                  </Text>
                </TouchableOpacity>
          ...
          <LinearGradient
            ...
            <View className="flex flex-row justify-around w-full items-center">
              <View className="flex flex-col items-start px-2 gap-2 bg-[#fefce8] w-[60%] h-[100px] rounded-2xl justify-center">
                <Text className="text-[#121212] font-bold text-[13px]">
                  10% Off for an Insta Story !
                </Text>
                <Text className="text-[#121212]  rounded-lg  font-bold text-[14px]">
              ...
              <TouchableOpacity onPress={handleInstagramRedirect}>
                <View>
                  ...
                  <View className="flex flex-row items-center  justify-between">
                    ...
                    <Ionicons
                      name="rocket-sharp"
                      className="text-[#121212] font-bold text-[70px]"
                      color="#581c87"
                    />
                  </View>
                </View>
          ...
          <LinearGradient
            ...
            <View className="flex flex-row items-start w-full  justify-around">
              <View className="flex flex-col gap-2 ">
                ...
                <Text className="text-[#121212] font-light">
              ...
              <TouchableOpacity onPress={handleInstagramRedirect}>
                <View className="flex flex-col items-center gap-2">
                  ...
                  <View className="flex flex-row items-center justify-between">
                    <Text className="text-[#121212] font-medium text-[12px] mr-1">
                      Post now
                    </Text>
                    <Ionicons
                      name="rocket"
